package com.example.calculadora_dsm_desafio
...
class MainActivity : AppCompatActivity() {
    ...
    fun calcular(view : View){
        ...
        var mostrarSinCeros=quitarCerozIzquierda(concatenar)
        if (textoBoton=="="){
            var resultado=0.0
            try {
            ...
            tvRes?.text=mostrarSinCeros
        }

    }
    fun quitarCerozIzquierda(str : String):String{
        var i=0
